...
class GardenEntry(models.Model):
    ...
    #Probably not needed
    UserEntryNum = models.CharField(max_length=20, help_text='Enter username and entry number (ex. P1Ent1 for user P1 first entry)')

    #How are we storing pictures and sound?
    #pip install pillow
    #picture = models.ImageField(upload_to='images/', 
                                #help_text='Upload an update picture of your plant')
